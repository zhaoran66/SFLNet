...
class QuickEvaluator:
    def __init__(self, model, diffusion, interpolator, val_loader, config, num_samples=20):
        self.model = model
    ...
    def evaluate(self):
        ...
        print("\n" + "="*60)
        print("Quick Evaluation Results (on interpolated frames):")
...
if __name__ == "__main__":
    ...
    evaluator = QuickEvaluator(model, diffusion, interpolator, val_loader, config, num_samples=20)
    evaluator.evaluate()
