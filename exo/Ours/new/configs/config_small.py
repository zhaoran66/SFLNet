...
class ModelConfig:
    ...
    hidden_size: int = 256          # 从 512 降到 256，显存减半
    num_heads: int = 4               # 从 8 降到 4
    num_layers: int = 6              # 从 12 降到 6
    mlp_ratio: float = 4.0
    dropout: float = 0.1
    ...
    routing_hidden_dim: int = 64     # 从 128 降到 64
...
class Config:
    ...
    output_dir: str = "./outputs_fasr_small"
    seed: int = 42
    model_name: str = "FASR-Small"
