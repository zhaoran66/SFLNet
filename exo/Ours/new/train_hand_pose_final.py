"""
Hand Pose Estimation Training Script - 4 Methods
=================================================
...
def main():
    parser = argparse.ArgumentParser(description='Train Hand Pose Estimation - 4 Methods')
    ...
    print("="*70)
    print("Hand Pose Estimation Training")
    print("="*70)
    ...
    if args.method == 'baseline':
        ...
        print("Creating DINOv2 feature extractor...")
        feature_extractor = DINOv2FeatureExtractor(output_size=(32, 32))
        model = HandPoseOurs(
            feat_dim=384,
            num_frames=config.data.num_frames,
            hidden_dim=256,
