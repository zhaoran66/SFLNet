...
from model import HandPoseLatentFreq
...
def main():
    ...
    print("=" * 70)
    print("Experiment 4: Baseline + Latent + Frequency Decomposition")
    print("=" * 70)
    print("Input:  (B, 3, T, 128, 128)  RGB video")
    print("Output: (B*T, 51)              MANO hand pose")
    print("Pipeline: RGB -> VAE -> Freq-split -> LatentEncoder(x2) -> Regressor")
    print("=" * 70)
