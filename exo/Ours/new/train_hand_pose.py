"""
Hand Pose Estimation Training Script - 4 Unified Methods
All methods have SAME interface: Input (B, 3, T, 128, 128) -> Output (B*T, 51)

Run on different GPUs:
  CUDA_VISIBLE_DEVICES=1 python train_hand_pose.py --method baseline
  CUDA_VISIBLE_DEVICES=2 python train_hand_pose.py --method freq_decomp
  CUDA_VISIBLE_DEVICES=4 python train_hand_pose.py --method latent_only
  CUDA_VISIBLE_DEVICES=5 python train_hand_pose.py --method latent_freq
"""
import os
...
def main():
    parser = argparse.ArgumentParser(description='Train Hand Pose Estimation - 4 Unified Methods')
    ...
    print("="*70)
    print("Hand Pose Estimation Training - 4 Unified Methods")
    print("="*70)
