...
def main():
    ...
    parser.add_argument("--checkpoint", type=str, default="./outputs_with_bg/checkpoints/best.pt")
    ...
    for batch_idx, batch in enumerate(tqdm(val_loader, total=args.num_samples)):
        ...
        x = torch.randn(B, C, num_history + 4, H, W, device=device)
    ...
    print("\n" + "=" * 60)
    print("EVALUATION RESULTS (Syn2Seq + Background Processing)")
    print("=" * 60)
